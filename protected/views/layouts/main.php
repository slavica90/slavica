...
<div class="container" id="page">
	...
	<div id="mainmenu">
        ...
        array('label'=>'Book Reviews', 'url'=>array('/review/index'), 'visible'=>((Yii::app()->user->id)==10)),
...
<div id="maincontainer">
  <div id="main1">
    <div id="EventCalendar">
       ...
       <div id="leftmenu">
            <?php $kategorii=Category::model()->findAll( ); ?>
              <?php if($kategorii != NULL) {?>
              <?php foreach ($kategorii as $kategorija){?>
               <ul>
                <li><a href="<?php echo Yii::app()->createUrl('book/knigikategorija',array('id'=>$kategorija->id) )?>"><?php echo $kategorija->category_name;?> </a></li>
               </ul>
            <?php } ?>
            <?php } ?>
        
      </div>
<!--      <div id="socialbuttons12">
         <div class="sbuttons">  <img src="images/googleplus.png" width="30" />  </div>
          <div class="sbuttons">  <img src="images/facebook.png"width="30"/>  </div>
          <div class="sbuttons">  <img src="images/twiter.png" width="30"/>  </div>
     </div>-->
    
      <?php if (Yii::app()->user->isGuest){ ?>
      <div id="side">
      <?php $this->renderPartial('//site/login',array('model'=>new LoginForm));?>
        <?php echo CHtml::link('New Member? <br> Register now!', Yii::app()->createUrl('user/register')); ?>
      </div>
      <?php } else {
