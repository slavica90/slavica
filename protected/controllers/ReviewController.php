...
class ReviewController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'novoreview'),
				'users'=>array('@'),
			),
  ...
  public function actionNovoreview()
	{
    $review = new Review;
		 if(isset($_POST['Review']) && isset($_GET['idkniga']))
		{
       $idkniga=$_GET['idkniga'];
			$review->attributes=$_POST['Review'];
      $review->book_id = $idkniga;
			if($review->save())
				$this->redirect(Yii::app()->createUrl('book/view', array('id'=>$idkniga)));
		}
    else {
